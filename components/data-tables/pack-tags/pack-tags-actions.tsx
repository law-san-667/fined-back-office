import PackTagsForm from "@/components/forms/pack-tags-form";
...
const PackTagsActions: React.FC<PackTagsActionsProps> = ({ tag }) => {
  ...
  const { mutate: deleteTag, isPending: isDeleting } =
    trpc.packTags.deleteTag.useMutation({
      onSuccess: () => {
    ...
    <div className="flex items-center gap-2">
      <Dialog open={openUpdate} onOpenChange={setOpenUpdate}>
        ...
        <DialogContent>
          ...
          <PackTagsForm name={tag.name} setOpenUpdate={setOpenUpdate} />
        </DialogContent>
      </Dialog>
...
export default PackTagsActions;
