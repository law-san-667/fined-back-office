...
type PostTagsActionsProps = {
  tag: Database["public"]["Tables"]["post_tags"]["Row"];
};

const PostTagsActions: React.FC<PostTagsActionsProps> = ({ tag }) => {
  ...
  const { mutate: deleteTag, isPending: isDeleting } =
    trpc.postTags.deleteTag.useMutation({
      onSuccess: () => {
    ...
    <div className="flex items-center gap-2">
      <Dialog open={openUpdate} onOpenChange={setOpenUpdate}>
        ...
        <DialogContent>
          ...
          <PostTagsForm name={tag.name} setOpenUpdate={setOpenUpdate} />
        </DialogContent>
      </Dialog>
...
export default PostTagsActions;
