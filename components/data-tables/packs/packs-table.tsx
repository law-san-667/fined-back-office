...
import { PacksToolbar } from "./packs-toolbar";

interface PacksTableProps<TData, TValue> {
  columns: ColumnDef<TData, TValue>[];
  data: TData[];
  client?: boolean;
}

export function PacksTable<TData, TValue>({
  columns,
  data,
  client,
}: PacksTableProps<TData, TValue>) {
